...
public class Login_Application_page_obj_pattern {
	...
	public void login_pop() {
		...
		LinkedInLoginpage_Page_Object_pattern login_page_obj_ref = new LinkedInLoginpage_Page_Object_pattern(ch_driver_1);
